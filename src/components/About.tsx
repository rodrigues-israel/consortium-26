  ...
  return (
    <>
      <div className="bg-linear-to-b from-black to-red-900">
        ...
        <p className="text-white text-center p-5 mt-5 pb-5 text-2xl font-montserrat md:p-10 md:text-3xl">
          ...
          attendees. Join us to ignite your entrepreneurial spark at Consortium!
        </p>

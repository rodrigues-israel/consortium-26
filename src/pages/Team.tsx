...
import abhijeet from "@/assets/team/abhijeet.webp";
import tanvi from "@/assets/team/tanvi.webp";
import prashant from "@/assets/team/prashant.webp";
import sriram from "@/assets/team/sriram.webp";
import anushka from "@/assets/team/anushka.webp";
import rakshit from "@/assets/team/rakshit.webp";
import prince from "@/assets/team/prince.webp";
import chavan from "@/assets/team/chavan.webp";
import sahil from "@/assets/team/sahil.webp";
    ...
    <>
      ...
      >
        <div className="flex justify-center">
          <SplitText
            text="ADVISORY"
            className="text-white text-shadow-lg text-shadow-red-900 text-center text-5xl md:text-7xl font-poppins font-bold mt-10 p-5"
            delay={100}
            duration={0.6}
            ease="power3.out"
            splitType="chars"
